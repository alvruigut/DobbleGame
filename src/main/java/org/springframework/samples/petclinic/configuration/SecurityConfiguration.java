...
public class SecurityConfiguration {
	...
	protected SecurityFilterChain configure(HttpSecurity http) throws Exception {
		...
		http
			...
			.requestMatchers(AntPathRequestMatcher.antMatcher("/api/v1/players/**")).hasAnyAuthority(ADMIN)
			.requestMatchers(AntPathRequestMatcher.antMatcher("/api/v1/games/**")).hasAnyAuthority(ADMIN, PLAYER)
			.requestMatchers(HttpMethod.GET, "/api/v1/gameProperties/**").hasAuthority(PLAYER)
			.requestMatchers(HttpMethod.GET, "/api/v1/games/**").hasAuthority(PLAYER)
			.requestMatchers(HttpMethod.GET, "/api/v1/games/**").permitAll()
			.requestMatchers(HttpMethod.POST, "/api/v1/games/**").hasAuthority(PLAYER)
			.requestMatchers(AntPathRequestMatcher.antMatcher("/api/v1/gameProperties/**")).hasAnyAuthority(ADMIN, PLAYER)
			.requestMatchers(AntPathRequestMatcher.antMatcher("/api/v1/rounds/**")).hasAnyAuthority(ADMIN, PLAYER)
			.requestMatchers(AntPathRequestMatcher.antMatcher("/api/v1/profile/**")).hasAuthority(PLAYER)
