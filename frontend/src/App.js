...
import EditPlayer from "./player/editPlayer/EditPlayer";
import Stadistics from "./player/stadistics/Stadistics";
import PlayerListAdmin from "./admin/players/PlayerListAdmin";
import WinnersScreen from "./game/winnersScreen";
import ScreenAdminHome from "./admin/home/ScreenAdminHome";

import Duration from "./player/stadistics/Duration";
import Global from "./player/stadistics/Global";
import Personal from "./player/stadistics/Personal";
import Logros from "./player/stadistics/Logros";

import PlayerIndex from "./player";
import CreateGame from "./player/createGame";

import Lobby from "./game/lobby"
import GameScreen from "./game/gameScreen"
import HotPotato from "./game/hotPotatoGameScreen"
...
function App() {
  ...
  roles.forEach((role) => {
    if (role === "ADMIN") {
      adminRoutes = (
        <>
          ...
          <Route path="/admin" element={<PrivateRoute><ScreenAdminHome /></PrivateRoute>} />
          <Route path="/players" exact={true} element={<PrivateRoute><PlayerListAdmin /></PrivateRoute>} />
          <Route path="/players/:id" exact={true} element={<PrivateRoute><PlayerEditAdmin /></PrivateRoute>} />
    ...
    if (role === "PLAYER") {
      vetRoutes = (
        <>
          <Route path="/profile" exact={true} element={<PrivateRoute><EditPlayer /></PrivateRoute>} />
          <Route path="/stadistics" exact={true} element={<PrivateRoute><Stadistics /></PrivateRoute>} />
          <Route path= "/stadistics/globals" exact={true} element={<PrivateRoute><Global /></PrivateRoute>} />
          <Route path= "/stadistics/personal" exact={true} element={<PrivateRoute><Personal /></PrivateRoute>} />
          <Route path= "/stadistics/duracion" exact={true} element={<PrivateRoute><Duration /></PrivateRoute>} />
          <Route path= "/stadistics/logros" exact={true} element={<PrivateRoute><Logros /></PrivateRoute>} />
          <Route path="/player" exact={true} element={<PrivateRoute><PlayerIndex /></PrivateRoute>} />
          <Route path="/createGame" exact={true} element={<PrivateRoute><CreateGame /></PrivateRoute>} />
          <Route path="/lobby/:id" exact={true} element={<PrivateRoute><Lobby /></PrivateRoute>} />
          <Route path="/game/:gameId/round/:roundId" exact={true} element={<PrivateRoute><GameScreen /></PrivateRoute>} />
          <Route path="/game/:gameId/round/:roundId/hotPotato" exact={true} element={<PrivateRoute><HotPotato /></PrivateRoute>} />
          <Route path="/game/:gameId/winners" exact={true} element={<PrivateRoute><WinnersScreen /></PrivateRoute>} />
        </>
      );
    }
  })
